...
for anchor in anchor*/md/ens_equil; do
 ...
 python ~/SEEKR/tools/analysis/equil_md.py '../building/holo.parm7' 'ens_equil_center.dcd' 'MOL'
...
for anchor in anchor*/md/fwd_rev; do
 ...
 cd $anchor
 python ~/SEEKR/tools/analysis/fhpd_md.py '../building/holo.parm7' '../ens_equil/ens_equil_center.dcd' 1 'MOL'
 cd ../../../
 done
